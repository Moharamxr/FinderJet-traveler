...
import FlightDatePicker from "@/app/_components/inputs/DatePicker/FlightDatePicker";
...
const ReportForm = () => {
  ...
  const [isReceivedReportModalOpen, setIsReceivedReportModalOpen] =
  ...
  const buttonClasses =
    "px-6 py-3 text-lg rounded-2xl cursor-pointer transition-all duration-300";
  ...
  return (
    <>
      ...
      <form className="bg-white rounded-[20px] p-8 w-full lg:w-9/12 flex flex-col gap-4">
        ...
        <h3 className=" font-medium tracking-wide mb-5">
        ...
        <ReceivedReportModal
          isOpen={isReceivedReportModalOpen}
          setIsOpen={setIsReceivedReportModalOpen}
        />
      </form>
    </>
  );
